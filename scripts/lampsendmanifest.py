...
def do_sendmanifest(manifest_xml, slice_id, credential):
    ...
    if ns == "http://protogeni.net/resources/rspec/0.1":
        print "Detected rspec version 0.1"
        unis_dom = manifest_to_unis(manifest_dom, slice_id)
    elif ns == "http://protogeni.net/resources/rspec/0.2":
        print "Detected rspec version 0.2"
        unis_dom = manifest_to_unis(manifest_dom, slice_id)
    elif ns == "http://www.protogeni.net/resources/rspec/2":
        print "Detected rspec version 2"
